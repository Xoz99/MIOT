      ...
      <div className="bg-white/80 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-slate-200/50 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <input
            ...
            className="w-full px-4 py-4 bg-slate-50/50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-all duration-200 placeholder-slate-500"
            required
          />
          <input
            type="password"
          ...
          <button 
            type="submit"
            className="w-full bg-gradient-to-r from-slate-600 to-slate-700 text-white py-4 rounded-2xl hover:from-slate-700 hover:to-slate-800 font-semibold transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
          >
            Masuk ke Dashboard
          </button>
        </form>
